...
void   c_init(/*_ void _*/);                /* Initialize global polynomials */

/* c_handle: Merge the tag of a new weave with the list of all new weaves */
void   c_handle(/*_ word *list, struct weave *thisweave, 
                    struct weave *newweaves _*/);

/* c_follow: Follow all instructions, return the poly for the original link */
void   c_follow(/*_ struct instruct *l, word crossings, 
                    struct poly **answer _*/);
