...
word       left;                 /* Is the crossing being added righthanded? */
...
void   b_manip(/*_ weave *oldweaves _*/);
...
/* Add a crossing to a single weave without removing any pair of boundary
   ...
   weaves.  */
void   b_no_pairs(/*_ word *list, word *list2, word *one, word *two _*/);
...
void   b_one_pair(/*_ word *list, word *list2, word *one, word *two _*/);
...
/*
---------------------------------------------------------------------------
  Should the crossing of *first* and *second* in *list* be lefthanded?    *i*.
---------------------------------------------------------------------------
*/
#define b_left( list, going_in, first, second, i ) \
if (1) \
{ \
